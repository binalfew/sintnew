export function FullSintnewLogo({
  size,
  position,
}: {
  size: "sm" | "md" | "lg";
  ...
  return (
    ...
    >
      <SintnewLogo className={`relative top-[1px] ${logoSize}`} />
      <div className="w-1" />
      <div className={`font-display ${textSize}`}>Sintnew</div>
    </div>
  );
}

export function SintnewLogo({ className }: { className: string }) {
  return (
    <svg
      className={className}
      fill="none"
